...
Ово је само илустрација проблема, прича о динамичком заузимању меморије је мало
...
Нека се наредбом `p=(int*)calloc(n,sizeof(int))` резервише меморијски простор за смештање
