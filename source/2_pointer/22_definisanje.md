...
кодом је очигледан, пре свега због компактности записа.
```
...
Показивачи се дефинишу као и сви остали подаци у програму, с тим што се испред идентификатора податка додаје симбол ``*``. Општи облик наредбе за дефинисање показивача је тип ``*ime``. Тип означава тип податка на који показивач указује. Најчешће се показивач дефинише са ``*p``, али то не мора да буде правило.
