...
Листе су динамичке структуре података. Разликујемо једноструко повезане и двоструко повезане листе, затим стабла, графове итд. Чланови структуре могу бити и друге структуре. 
...
Приметићете да мора да се наведе назив структуре без обзира што смо навели структурни тип.  Ако то не урадимо, компајлер неће изјавити грешку, али ће дати упозорење.
...
Адреса првог чвора у листи се чува на посебној локацији која се зове *head* (глава) или prvi. Адресу првог чвора, као и наредних, резервишемо наредбом `malloc`. 
...
Једноструко спрегнута листа је листа која се састоји од чворова, а редослед чворова одређен је адресом која је записана у сваком чвору. На следећој слици приказан је пример једне листе.
...
Ако је адреса у последњем чвору `sl_adresa = NULL`, то значи да даље немамо елементе у листи.

Поставља се питање како можемо приступити податку у листи. Једноставно ћемо  дефинисати показивач у који ћемо уписивати адресе структура. Дефинишимо показивач чије име је `tekuci` и нека је његова почетна вредност иста као и вредност показивача `prvi`. 
