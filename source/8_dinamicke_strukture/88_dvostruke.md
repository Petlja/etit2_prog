...
омогућавају кретање кроз листу само у једном правцу. Даље, приликом брисања
...
показивач на последњи елемент `poslednji` и вредност која се уноси `n`.

Ако је листа празна, ако је `prvi == NULL`, значи да додајемо први елемент у
листу.

Додајемо меморију новом елементу – његов податак добија вредност унетог
...
Ако листа није празна, елемент додајемо на крај листе. После доделе меморије и
...
Функција за додавање елемента у листу би изгледала овако:
...
Приликом брисања елемената из двоструке листе није неопходно знати показивач на
